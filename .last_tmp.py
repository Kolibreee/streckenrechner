...
def ladestrecken(dateiname=streckenstandardname):
  try:	#falls die Datei noch nicht vorhanden ist
    ...
    try:
      ...
      report("Konnte die Datei nicht erstellen. Bis dieser Fehler behoben wurde werden alle Entfernungen nur temporaer gespeichert und gehen nach beenden wider verloren. OnlyOnlyUse")
      speicherbar=False ##Am ende frage ob der nutzer es erneut probieren will
    finally:
      strecken={}
      return True
  else:
